...
if __name__ == "__main__":
    ...
    train_game.simulateManyGames(1)
    ...
    print("Training")
    OthelloModel.train(train_in,train_out,1)
    print("Weights after training")
    print(OthelloModel.synaptic_weights)
    print("\n Model is Ready! \n")

    print("Testing Black Wins")
    train_game.simulateNNGames(1,OthelloModel,"B")
    input()
    #print("Testing White Wins")
    #train_game.simulateNNGames(100,OthelloModel,"W")